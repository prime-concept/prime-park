...
extension AttributedStringBuilder {
    func primeFont(
        ...
        if lineSpacing > 0 {
            return self.font(UIFont.primeParkFont(ofSize: size, weight: weight))
                .baselineOffset(CGFloat(lineSpacing))
                .lineHeight(lineHeight)
        }

        return self.font(UIFont.primeParkFont(ofSize: size, weight: weight)).lineHeight(lineHeight)
    }
    ...
    func boldPrimeFont(
        ...
        if lineSpacing > 0 {
            return self.font(UIFont.boldPrimeParkFont(ofSize: size))
                .baselineOffset(CGFloat(lineSpacing))
                .lineHeight(lineHeight)
        }

        return self.font(UIFont.boldPrimeParkFont(ofSize: size)).lineHeight(lineHeight)
    }
}
